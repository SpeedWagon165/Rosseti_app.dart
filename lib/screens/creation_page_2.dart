...
import 'creation_page_3.dart';

class CreationPage2 extends StatefulWidget {
  final String title;
  final int topicId;
  final String text;
  final File? image;
  ...
  @override
  State<CreationPage2> createState() => _MyStatefulWidgetState();
}

class _MyStatefulWidgetState extends State<CreationPage2> {
            ...
            children: [
              ...
              Wrap(
                ...
                children: [
                  ...
                  Center(
                    child: Text('Расскажите как надо',
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  onPressed: () async {
                    Navigator.of(context).push(
                      MaterialPageRoute(
                        builder: (context) => CreationPage3(
                          title: widget.title,
                          topicId: widget.topicId,
                          text: widget.text,
                          video: widget.video,
                          image: widget.image,
                          propText: textController.text,
                          propVideo: video,
                          propImage: image,
                        ),
                      ),
